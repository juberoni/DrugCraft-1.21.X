...
public class AcaciaWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<AcaciaWoodDryingTableBlock> CODEC = AcaciaWoodDryingTableBlock.createCodec(AcaciaWoodDryingTableBlock::new);


    public AcaciaWoodDryingTableBlock(Settings settings) {
        super(settings);
