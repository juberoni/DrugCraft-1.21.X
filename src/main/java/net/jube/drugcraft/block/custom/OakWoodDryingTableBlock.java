...
public class OakWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<OakWoodDryingTableBlock> CODEC = OakWoodDryingTableBlock.createCodec(OakWoodDryingTableBlock::new);


    public OakWoodDryingTableBlock(Settings settings) {
        super(settings);
