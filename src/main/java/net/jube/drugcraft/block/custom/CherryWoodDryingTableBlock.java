...
public class CherryWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<CherryWoodDryingTableBlock> CODEC = CherryWoodDryingTableBlock.createCodec(CherryWoodDryingTableBlock::new);


    public CherryWoodDryingTableBlock(Settings settings) {
        super(settings);
