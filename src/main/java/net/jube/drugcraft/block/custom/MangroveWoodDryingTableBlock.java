...
public class MangroveWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<MangroveWoodDryingTableBlock> CODEC = MangroveWoodDryingTableBlock.createCodec(MangroveWoodDryingTableBlock::new);


    public MangroveWoodDryingTableBlock(Settings settings) {
        super(settings);
