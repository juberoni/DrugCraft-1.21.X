...
public class JungleWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<JungleWoodDryingTableBlock> CODEC = JungleWoodDryingTableBlock.createCodec(JungleWoodDryingTableBlock::new);


    public JungleWoodDryingTableBlock(Settings settings) {
        super(settings);
