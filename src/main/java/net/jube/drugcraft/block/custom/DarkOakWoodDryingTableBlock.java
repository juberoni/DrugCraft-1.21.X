...
public class DarkOakWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<DarkOakWoodDryingTableBlock> CODEC = DarkOakWoodDryingTableBlock.createCodec(DarkOakWoodDryingTableBlock::new);


    public DarkOakWoodDryingTableBlock(Settings settings) {
        super(settings);
