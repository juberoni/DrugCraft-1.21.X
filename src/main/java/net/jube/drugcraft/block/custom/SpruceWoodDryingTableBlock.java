...
public class SpruceWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SpruceWoodDryingTableBlock> CODEC = SpruceWoodDryingTableBlock.createCodec(SpruceWoodDryingTableBlock::new);


    public SpruceWoodDryingTableBlock(Settings settings) {
        super(settings);
