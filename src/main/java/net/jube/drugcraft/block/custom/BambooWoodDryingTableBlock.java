...
public class BambooWoodDryingTableBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<BambooWoodDryingTableBlock> CODEC = BambooWoodDryingTableBlock.createCodec(BambooWoodDryingTableBlock::new);


    public BambooWoodDryingTableBlock(Settings settings) {
        super(settings);
